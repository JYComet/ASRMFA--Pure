...
NVV_TO_MFA={'Breathing':'BREATHING','Laughter':'LAUGHTER','Burp':'BURP','Cough':'COUGH','Crying':'CRYING','Groan':'GROAN','Hiss':'HISS','Hum':'HUM','Shh':'SHH','Sigh':'SIGH','Sneeze':'SNEEZE','Sniff':'SNIFF','Snore':'SNORE','Tsk':'TSK','Uhm':'UHM','Whistle':'WHISTLE','Yawn':'YAWN'}
